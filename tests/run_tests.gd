...
##
## 메인 씬 대신 이 씬을 띄우면 오토로드(Balance, Num, Prestige, Rebirth, Party, Skills, Training, Promotions, Game, Achievements, Equipment, Automation, Challenges, Tower, Save)가 그대로 뜬다.
