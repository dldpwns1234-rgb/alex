...
enum Stat { STAGE, KILLS, BOSS_KILLS, GOLD, TAPS, PRESTIGES, SKILLS, HERO_LEVEL, PARTY }
...
const STAT_LABELS: Dictionary = {
	...
	Stat.PRESTIGES: "회귀", Stat.SKILLS: "스킬", Stat.HERO_LEVEL: "용사", Stat.PARTY: "동료",
}
...
const STAT_GOAL_FORMATS: Dictionary = {
	...
	Stat.HERO_LEVEL: "용사 Lv %s 도달", Stat.PARTY: "동료 %s명 고용",
}
